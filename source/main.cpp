...
int main(int argc, char * argv[])
{
	...
	if (argc == 2)
	{
		...
		if (enteredCommand == "-h")
		{
			...
			std::cout << "All commands provide step-by-step explaination when executed.\n" << "  Main Menu commands:" << menuHelp << "\n  Movie Commands:" << movieHelp << "\n  Character Commands" << characterHelp << "\n  Scene Commands:" << sceneHelp;
			return 0;
		}
	}
